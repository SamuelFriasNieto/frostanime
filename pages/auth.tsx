...
const Auth = () => {
    ...
    return (
        <div className="relative h-full w-full bg-[url('/images/hero.png')] bg-no-repeat bg-center bg-fixed bg-cover">
            <div className="bg-pink-950 lg:bg-black w-full h-full lg:bg-opacity-50">
                <nav className="px-12 py-5">
                    <img src="/images/logo.png" alt="Logo" className="h-14" />
                </nav>
                <div className="flex justify-center">
                    <div className="bg-pink-950 lg:bg-black bg-opacity-70 px-16 py-16 self-center mt-2 lg:w-1/4 min-w-96 lg:bg-opacity-70  rounded-md w-full">
